...
REPORT_PATH = os.path.join(ROOT, "evaluations", "baseline_model_reports", "rf_report.md")
...
PARAM_GRID = [
    ...
    {"n_estimators": 300, "max_depth": 24, "min_samples_leaf": 5},
    {"n_estimators": 300, "max_depth": 24, "min_samples_leaf": 10},
...
def main():
    ...
    for params in PARAM_GRID:
        fit = RandomForestRegressor(n_jobs=-1, random_state=SEED, **params)
    ...
    for params, val_mae in tuned:
        lines.append(
            f"| {params['n_estimators']} | {params['max_depth']} | {params['min_samples_leaf']} | {val_mae:.4f} |"
        )
    lines += [
        "",
